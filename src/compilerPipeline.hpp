...
namespace amanises {
	...
	private:
		...
		void process_token_lists(CompilerSetup* compiler_setup, std::vector<std::pair<std::string, std::vector<Token>>>& src_and_tok_lists, std::vector<const char*>& src_path_list);
	};
}
